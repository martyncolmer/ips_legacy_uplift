...
survey_data_path = r"\\nsdata3\Social_Surveys_team\CASPA\IPS\Testing\TestInputFiles\testdata.sas7bdat"
...
#transpose_survey_data.transpose(survey_data_path,version_id)



# Populate Survey sub-sample
populate_survey_subsample.populate(run_id, connection, version_id)

print("AT THE SYS>EXIT CALL")
sys.exit()
