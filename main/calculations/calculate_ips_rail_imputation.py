...
def calculate(survey_data, var_serial, var_final_weight, minimum_count_threshold=30):
    """
    Author       : Thomas Mahoney
    Date         : 28 / 02 / 2018
    Purpose      : Calculates the imputed values for rail expenditure for the IPS system.
    ...
    output_dataframe = do_ips_railex_imp(df_surveydata, var_serial, var_final_weight, minimum_count_threshold)
